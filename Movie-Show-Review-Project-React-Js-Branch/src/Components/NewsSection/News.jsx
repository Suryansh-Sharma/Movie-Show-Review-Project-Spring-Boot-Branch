                        ...
                        (Flag.one === true) ?
                            <article className="postcard light blue">
                                ...
                                <div className="postcard__text t-dark">
                                    <h1 className="postcard__title blue"><a href={data.url}
                                                                            target="_blank">{data.title}</a></h1>
                    ...
                    }
                    {
                        (Flag.two === true) ?
                            <article className="postcard light red">
                                ...
                                <div className="postcard__text t-dark">
                                    <h1 className="postcard__title red"><a href={data.url}
                                                                           target="_blank">{data.title}</a></h1>
                                    <div className="postcard__subtitle small">
                                        <time>
                                            <i className="fas fa-calendar-alt mr-2">{data.publishedAt}</i>
                    ...
                    }
                    {
                        (Flag.third === true) ?
                            <article className="postcard light green">
                                ...
                                <div className="postcard__text t-dark">
                                    <h1 className="postcard__title green"><a href={data.url}
                                                                             target="_blank">{data.title}</a></h1>
                                    <div className="postcard__subtitle small">
                                        <time>
                                            <i className="fas fa-calendar-alt mr-2">{data.publishedAt}</i>
                    ...
                    }
                    {
                        (Flag.fourth === true) ?
                            <article className="postcard light yellow">
                                ...
                                <div className="postcard__text t-dark">
                                    <h1 className="postcard__title yellow"><a href={data.url}
                                                                              target="_blank">{data.title}</a></h1>
                                    <div className="postcard__subtitle small">
                                        <time>
                                            <i className="fas fa-calendar-alt mr-2">{data.publishedAt}</i>
