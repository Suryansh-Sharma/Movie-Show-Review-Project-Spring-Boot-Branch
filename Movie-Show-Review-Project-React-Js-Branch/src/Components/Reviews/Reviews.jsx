        ...
        <div className='col-md-6'>
          <form onSubmit={handleFormSubmit}>
            ...
            <div className='form-group'>
              ...
              <select className='form-control' id='exampleFormControlSelect2' onChange={handleInputChange} name={"bestActor"}
            ...
            <div className='form-group'>
              ...
              <textarea className="form-control" id="exampleFormControlTextarea1" rows="3" placeholder={"Optional"}
